...
# Project: C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\Electrostimulation\Electrostimulation.cydsn\Electrostimulation.cyprj
# Date: Wed, 19 Oct 2022 09:38:30 GMT
#set_units -time ns
...
create_clock -name {SPI_IMU_IntClock(routed)} -period 500 -waveform {0 250} [list [get_pins {ClockBlock/aclk_1}]]
...
create_generated_clock -name {CLOCK_PWM} -source [get_pins {ClockBlock/clk_sync}] -edges {1 161 321} -nominal_period 3333.333333333333 [list [get_pins {ClockBlock/dclk_glb_3}]]
...
create_generated_clock -name {SPI_IMU_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 25 49} [list [get_pins {ClockBlock/aclk_glb_1}]]
...
# Component constraints for C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\Electrostimulation\Electrostimulation.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\Electrostimulation\Electrostimulation.cydsn\Electrostimulation.cyprj
# Date: Wed, 19 Oct 2022 09:38:16 GMT
