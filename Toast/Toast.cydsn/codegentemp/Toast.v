...
module top ;
    ...
    ShiftReg_v2_30_9 SHIFTREG_ENC_1 (
        .clock(Net_3419),
        .interrupt(Net_7173),
        .load(1'b0),
        .reset(Net_8905),
    ...
    ShiftReg_v2_30_10 SHIFTREG_ENC_2 (
        .clock(Net_3419),
        .interrupt(Net_7169),
        .load(1'b0),
        .reset(Net_8906),
    ...
    ShiftReg_v2_30_11 SHIFTREG_ENC_3 (
        .clock(Net_3419),
        .interrupt(Net_7166),
        .load(1'b0),
        .reset(Net_3492),
