...
# Project: C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\IMU\Sample_saved_on_PC_array\FW_Accelerometer_acquisition_time\Generic.cydsn\Generic.cyprj
# Date: Wed, 19 Oct 2022 09:50:30 GMT
#set_units -time ns
...
create_generated_clock -name {CLOCK_ENCODERS} -source [get_pins {ClockBlock/clk_sync}] -edges {1 49 97} [list [get_pins {ClockBlock/dclk_glb_4}]]
create_generated_clock -name {CLOCK_PWM_BLINK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 96001 192001} [list [get_pins {ClockBlock/dclk_glb_5}]]
create_generated_clock -name {counter_cyc_clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 960001 1920001} [list [get_pins {ClockBlock/dclk_glb_6}]]

set_false_path -from [get_pins {__ONE__/q}]

# Component constraints for C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\IMU\Sample_saved_on_PC_array\FW_Accelerometer_acquisition_time\Generic.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\mgnocco\OneDrive - Fondazione Istituto Italiano Tecnologia\Firmware\Psoc5\IMU\Sample_saved_on_PC_array\FW_Accelerometer_acquisition_time\Generic.cydsn\Generic.cyprj
# Date: Wed, 19 Oct 2022 09:50:15 GMT
